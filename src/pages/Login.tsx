			...
			<div className="flex flex-col xs:w-2/3 xs:min-w-[300px] w-full px-3 max-w-[500px] md:w-1/2 ">
				<div className="flex items-center justify-between">
					...
					<div className="flex items-center text-xl">
						...
						<Link to='/signup' className="text-orange-600 underline ml-2 cursor-pointer">Register</Link>
					</div>
				</div>
				<div className="flex flex-col-reverse mt-4 text-xl">
					...
					/>
					<label htmlFor="email" className="font-semibold px-2 text-base lablel">Email</label>
				</div>
				<div className="flex flex-col-reverse mt-8 text-xl">
					...
					/>
					<label htmlFor="password" className="font-semibold px-2 text-base lablel">Password</label>
				</div>
				<p className="mt-4 px-2 cursor-pointer hover:text-orange-600 duration-300">
					Forget Password?
				</p>
				<button 
					className="bg-orange-600 text-white font-semibold mt-6 py-3 rounded-[2em] text-xl hover:bg-orange-500 transition duration-200"
				>
					Login
				</button>
			</div>
